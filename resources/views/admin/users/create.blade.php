...
<li class="breadcrumb-item active" aria-current="page">Agregar/Editar Usuarios</li>
@endsection
@section('content')
<h2 class="modal-title">Agregar/Editar Usuarios</h2>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <label class="form-control-label">Saleccionar Privilegio</label>
            ...
            <ul class="list-group row">
                ...
                <li class="list-group-item">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            @if(isset($user))
                            <input type="submit" name="submit" class="btn btn-primary btn-block " value="Actualizar Usuario" />
                            @else
