...
<li class="breadcrumb-item active" aria-current="page">Agregar/Editar Productos</li>
@endsection
@section('content')
<h2 class="modal-title">Agregar/Editar Productos</h2>
    ...
    <div class="row">
            ...
            <div class="form-group row">
                <div class="card col-sm-12 p-0 mb-2">
                    <div class="card-header align-items-center">
                        <h5 class="card-title float-left">Opciones extra</h5>
        ...
        <div class="col-lg-3">
            <ul class="list-group row">
                ...
                <li class="list-group-item active"><h5>Imagen</h5></li>
                <li class="list-group-item">
                    <div class="input-group mb-3">
                        <div class="custom-file ">
                            <input type="file"  class="custom-file-input" name="thumbnail" id="thumbnail">
                            <label class="custom-file-label" for="thumbnail">Archivo</label>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <p type="text" class="form-control" name="featured" placeholder="0.00" aria-label="featured" aria-describedby="featured" >Producto</p>
                        </div>
                    </div>
                </li>
                ...
                @endphp
                <li class="list-group-item active"><h5>Seleccionar Categoría</h5></li>
                <li class="list-group-item ">
                ...
                <li class="list-group-item">
                    <div class="form-group row">
                        <select class="form-control" id="status" name="status">
                            <option value="0" @if(isset($product) && $product->status == 0) {{'selected'}} @endif >Pendiente</option>
                            <option value="1" @if(isset($product) && $product->status == 1) {{'selected'}} @endif>Publicar</option>
                        </select>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            @else
                            <input type="submit" name="submit" class="btn btn-primary btn-block " value="Agregar Producto" />
                            @endif
                        </div>
                    </div>
                </li>
